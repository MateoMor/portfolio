...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_6xxffjr', 'template_0qvk70b', form.current, '8XcoWex1U-TG89EjZ')
      .then((result) => {
            ...
            <form ref={form} onSubmit={sendEmail}>
              ...
              <div className="flex justify-between ">
                <div className="underline">
                  <a href="mailto:mateo.morales.dev@gmail.com" target="_blank">
                    Send me email directly
                  </a>
                </div>
                <button className="bg-indigo-500 text-white px-4 py-2 w-40 rounded-md hover:bg-indigo-400 cursor-pointer">
